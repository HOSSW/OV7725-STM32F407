 ...
 * @date       :2018-08-09 
 * @function   :draw a point in LCD screen 在LCD屏幕上打印一个点
 ...
 * @date       :2018-08-09 
 * @function   :fill the specified area 填写指定区域
 ...
 * @date       :2018-08-09 
 * @function   :Draw a line between two points 在两点之间划一条线
 ...
 * @date       :2018-08-09 
 * @function   :Draw a rectangle			画一个矩形
 ...
 * @date       :2018-08-09 
 * @function   :Filled a rectangle		填充一个矩形
 ...
 * @date       :2018-08-09 
 * @function   :Display a single English character  	显示一个英文字符
 ...
 * @date       :2018-08-09 
 * @function   :Display English string		显示英文字符串
 ...
 * @date       :2018-08-09 
 * @function   :get the nth power of m (internal call)	得到m的n次幂(内部调用)
 ...
 * @date       :2018-08-09 
 * @function   :Display a single 16x16 Chinese character	显示一个16x16的汉字
 ...
 * @date       :2018-08-09 
 * @function   :Display a single 24x24 Chinese character	显示一个24x24的汉字
 * @parameters :x:the bebinning x coordinate of the Chinese character
                y:the bebinning y coordinate of the Chinese character
								fc:the color value of Chinese character
								bc:the background color of Chinese character
 ...
 * @date       :2018-08-09 
 * @function   :Display a single 32x32 Chinese character	显示一个32x32的汉字
 * @parameters :x:the bebinning x coordinate of the Chinese character
                y:the bebinning y coordinate of the Chinese character
								fc:the color value of Chinese character
								bc:the background color of Chinese character
 ...
 * @date       :2018-08-09 
 * @function   :Display Chinese and English strings	显示中文和英文字符串
 ...
 * @date       :2018-08-09 
 * @function   :Centered display of English and Chinese strings	英文和中文字符串的居中显示
 * @parameters :x:the bebinning x coordinate of the Chinese and English strings
                y:the bebinning y coordinate of the Chinese and English strings
								fc:the color value of Chinese and English strings
								bc:the background color of Chinese and English strings
 ...
 * @date       :2018-08-09 
 * @function   :Display a 16-bit BMP image	显示一个16位的BMP图像
...
void Gui_Drawbmp16(u16 x,u16 y,const unsigned char *p) //显示40*40 QQ图片
{
  int i; 
	...
	LCD_SetWindows(x,y,x+128-1,y+128-1);//窗口设置
    for(i=0;i<128*128;i++)
	{	
	 	picL=*(p+i*2);	//数据低位在前
		picH=*(p+i*2+1);				
...
/*****************************************************************************
 * @name       :void Gui_Drawbmp128(u16 x,u16 y,const unsigned char *p)
 * @date       :2018-08-09 
 * @function   :Display a 16-bit BMP image	显示一个16位的BMP图像
 * @parameters :x:the bebinning x coordinate of the BMP image
                y:the bebinning y coordinate of the BMP image
...
void Gui_Drawbmp128(u16 x,u16 y,unsigned char *p) //显示128*128
{
  int i; 
	unsigned char picH,picL; 
	LCD_SetWindows(x,y,x+128-1,y+128-1);//窗口设置
